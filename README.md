...
# How to use:
- Connect to the AP named `WiPhi_DEDSEC` with password `123456789` from your phone/PC.
...
- Once a correct password is found, AP will be restarted with default ssid `WiPhi_DEDSEC` / `123456789` and at the bottom of a table you should be able to see something like "Successfully got password for - `TARGET_SSID` - `PASSWORD`
